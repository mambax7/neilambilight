...
$readpermission=readpermission($user_uid=$suid);
 if (!empty($xoopsUser) and !empty($readpermission)) {
     ...
     $prderpeopletexbox="
   <div id='subscribereditmane' mane='39,".$suid."'></div>	
<ul class='list-group'>
  <li class='list-group-item'>"._MS_SHOPPINGCART31.""._MS_SHOPPINGCART46."".$neilshoporder['name']." &nbsp;<a class='btn btn-default btn-md' target='_blank' href='".XOOPS_URL."/modules/profile/userinfo.php?uid=".$neilshoporder['uid']."'>"._MS_SHOPPINGCART64."</a>".$blacklisttext."".$button."</li>
  <li class='list-group-item'>"._MS_SHOPPINGCART32.""._MS_SHOPPINGCART46."".$neilshoporder['phone']."</li>    
  <li class='list-group-item'>"._MS_SHOPPINGCART33.""._MS_SHOPPINGCART46."".$neilshoporder['telephone']."</li>  
   <li class='list-group-item'>"._MS_SHOPPINGCART34.""._MS_SHOPPINGCART46."".$neilshoporder['address']."</li> 
   <li class='list-group-item'>"._MS_SHOPPINGCART47.""._MS_SHOPPINGCART46."".$neilshoporder['email']."</li>       
</ul>
     <script src='".XOOPS_URL."/modules/neilshop/js/shoppingcartajax.js'></script>		
	";
