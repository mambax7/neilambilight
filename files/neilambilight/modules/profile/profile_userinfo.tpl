...
<div class="row">
    ...
    <div class="col-xs-6 col-md-6">
        ...
        <{if $user_ownpage == true}>
            <form name="usernav" action="user.php" method="post">
                <input class="btn btn-primary btn-lg btn-block" type="button" value="<{$lang_editprofile}>"
                       onclick="location='<{$xoops_url}>/modules/<{$xoops_dirname}>/edituser.php'">
                <input class="btn btn-primary btn-lg btn-block" type="button" value="<{$lang_changepassword}>"
                       onclick="location='<{$xoops_url}>/modules/<{$xoops_dirname}>/changepass.php'">
                <{if $user_changeemail}>
                    <input class="btn btn-primary btn-lg btn-block" type="button" value="<{$smarty.const._PROFILE_MA_CHANGEMAIL}>"
                ...
                <input class="btn btn-primary btn-lg btn-block" type="button" value="<{$lang_avatar}>" onclick="location='edituser.php?op=avatarform'">
                <input class="btn btn-primary btn-lg btn-block" type="button" value="<{$lang_inbox}>" onclick="location='<{$xoops_url}>/viewpmsg.php'">
                <input class="btn btn-primary btn-lg btn-block" type="button" value="<{$lang_logout}>"
